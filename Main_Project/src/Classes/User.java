...
public class User {
    ...
    private Istoric_Comenzi istoric_comenzi;
    ...
    public User(String nume,String adresa,String numar_telefon)
    {
        ...
        this.istoric_comenzi=new Istoric_Comenzi();
    }
    ...
    public Istoric_Comenzi getIstoric_comenzi() {
    ...
    public void setIstoric_comenzi(Istoric_Comenzi istoric_comenzi) {
