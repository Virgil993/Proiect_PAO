...
public class Services {
    ...
    private static SingletonWriteUser sl_user = SingletonWriteUser.getInstance();
    private static SingletonWriteSofer sl_sofer = SingletonWriteSofer.getInstance();
    ...
    public static void Adauga_Sofer(List<Sofer> lisa_soferi,List<User> lista_useri)
    {
        ...
        sl_sofer.writeSofer(lisa_soferi);
        sl_user.writeUser(lista_useri);
    ...
    public static void Sterge_Sofer(List<Sofer> lista_soferi,List<User> lista_useri){
        ...
        sl_user.writeUser(lista_useri);
        sl_sofer.writeSofer(lista_soferi);
